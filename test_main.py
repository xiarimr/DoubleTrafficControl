...
from agents.test_mappo import MAPPOAgent
from env.test_sumo import BatchSumoEnvManager
...
def train(
    ...
    return total_rewards_list, total_flows
...
def flows_plot(total_flows, save_path="flows.png"):
    steps = list(range(len(total_flows)))
